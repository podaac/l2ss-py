...
def update_netcdf_attrs(
    output_file: str,
    dataset: xr.DataTree,
    lon_var_names: list[str],
    lat_var_names: list[str],
    spatial_bounds_array: list | None = None,
    stage_file_name_subsetted_true: str | None = None,
    stage_file_name_subsetted_false: str | None = None,
) -> None:
    """
    ...
    if spatial_bounds_array is not None:
        ...
        bounds_mapping = {"geospatial_lat_max": (1, 1), "geospatial_lat_min": (1, 0)}
